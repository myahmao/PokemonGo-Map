...
dont_have_list = [1, 2, 3, 6, 8, 9, 12, 15, 25, 26, 31, 34, 35, 36, 37, 38, 39, 40, 45, 51, 62, 65, 66, 67, 68, 71, 
         76, 78, 80, 81, 82, 83, 86, 87, 89, 91, 92, 93, 94, 96, 97, 103, 106, 107, 108, 110, 113, 
         114, 115, 117, 121, 122, 123, 124, 128, 130, 131, 132, 134, 135, 137, 138, 139,
...
class Pokemon(BaseModel):
    ...
    def get_active(cls):
        ...
        for p in query:
            ...
            if p['pokemon_id'] in dont_have_list:
                pokemons.append(p)
